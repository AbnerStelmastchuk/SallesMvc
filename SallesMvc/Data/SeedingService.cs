...
using SallesMvc.Models.Enums;

namespace SallesMvc.Data
{
    public class SeedingService
    {
        private SallesMvcContext _context;
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Abner Stelmastchuk", "stelmastchukabner@gmail.com", new DateTime(1999, 6, 8), 3500.0, d2);
            Seller s3 = new Seller(3, "Amanda Sptizer", "amanda@gmail.com", new DateTime(1995, 5, 30), 2200.0, d1);
            ...
            SalesRecord r9 = new SalesRecord(9, new DateTime(2018, 09, 14), 11000.0, SalesStatus.Peding, s6);
            ...
            SalesRecord r12 = new SalesRecord(12, new DateTime(2018, 09, 25), 7000.0, SalesStatus.Peding, s3);
            ...
            SalesRecord r27 = new SalesRecord(27, new DateTime(2018, 10, 13), 9000.0, SalesStatus.Peding, s1);
